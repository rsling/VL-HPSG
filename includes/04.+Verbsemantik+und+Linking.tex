...
\begin{frame}
  ...
  auf die es rausläuft für \alert{Phonologie (\textsc{phon})}, \gruen{Syntax (\textsc{cat})} und \orongsch{Semantik (\textsc{cont})}\\
  \onslide<+->
  \Zeile
  \scalebox{0.8}{%
    \begin{avm}
...
\begin{frame}
  ...
  \scalebox{0.35}{%
    \begin{avm}
      \[ \asort{head-argument-phrase} 
        phon & Ein Ball fliegt \\
        cat & \[ head & \@1 \\
                 subcat & \<\> 
        \]\\
        cont & \@2 \\
        nhd-dtr & \@5 \[ \asort{head-argument-phrase} 
         phon & ein Ball \\
         cat & \[ head & \@8 \[ \asort{noun} cas & nom \] \\
           subcat & \<\> 
         \] \\
         cont & \@6 \\
         nhd-dtr & \@7 \[ \asort{word}  
           phon & ein \\
           cat & \[ head & \[ \asort{det} \] \] \\
         \] \\
         hd-dtr & \[ \asort{word} 
           ...
           cat & \[ head & \@8 \\
             subcat & \<\@7\>\] \\
             cont & \@6 \[ ind & \@3 \[ per & 3 \\ num & sg \\ gen & m \]\\
        ...
        hd-dtr & \[ \asort{word} 
         phon & fliegt \\
         cat & \[ head & \@1 \[ \asort{verb} vform & fin \] \\ 
           subcat & \< \@5 \>
         \] \\
         cont & \@2 \[ restr & \[ \asort{fly-rel} agent & \@3 \] \]\\
        \] \\
      \]
    \end{avm}
  }
