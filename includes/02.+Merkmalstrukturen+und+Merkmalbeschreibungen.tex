...
\begin{frame}
  ...
  \onslide<+->
  \onslide<+->
  Valenz | \alert{Liste von Merkmalbeschreibungen}\\
  ...
  \begin{avm}
    \[ \asort{finite-verb}
      ...
      tense & pres \\
      mod & ind \\
      \alert{subcat} & \alert{\< \[ \asort{noun} \], \[ \asort{noun} \]\>}
    \]
  \end{avm}
\end{frame}
...
\begin{frame}
  ...
  \grau{\footnotesize Achtung: Technisch gesehen geht HPSG ohne Unifikation; wir lesen am Ende \citet{Richter2021a} dazu.}\\
  \Viertelzeile
  \onslide<+->
